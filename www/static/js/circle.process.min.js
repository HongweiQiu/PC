var CircleProcess = (function(c) {
    ...
    b.fn = b.prototype = {
        ...
        _smallCircle: function(e, f, h) {   // 小圆
            var g = this.option;
        ...
        _getOption: function() {
            ...
            if (d.size === "complete") {
                ...
                this._extend(this.option, {
                    backgroundCircle: {
                        startAngle: Math.PI / 180 * 270,  // 调试小圆顺序
                        endAngle: Math.PI / 180 * 270 * 4  // 调试小圆顺序
                    }
                })
            } else {
